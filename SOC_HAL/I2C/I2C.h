 ...
 *
 *****************************************************************************/
void i2cInit(uint32 i2cFrequency);
 ...
 *
 *****************************************************************************/
sint8 i2cGetChar(uint8 mode, uint8* pData);
 ...
 *
 *****************************************************************************/
sint8 i2cWaitAfterTransmit(void);
 ...
 *
 *****************************************************************************/
sint8 i2cPutCharAndWait(uint8 data);
 ...
 *
 *****************************************************************************/
sint8 i2cWrite(uint8 addr, uint8 extraCmd, uint16 extra, uint8* pData, uint16 len);
 ...
 *
 *****************************************************************************/
sint8 i2cRead(uint8 addr, uint8* pBuf, uint16 len);
