...
void Print_Function_History(void)
{
  ...
  for(i = 0; i < MAX_FUNCTION_IN_BECKUP_BUFFER; i++)
  {
    ...
    case (RTC_INIT):
      printc(" - RTC_Init IN\n");
      break;
    case (RTC_INIT | FUNC_OUT_MASK):
      printc(" - RTC_Init OUT\n");
      break;
    case (RTC_SET_DATE):
      printc(" - RTC_Set_Date IN\n");
      break;
    case (RTC_SET_DATE | FUNC_OUT_MASK):
      printc(" - RTC_Set_Date OUT\n");
      break;
    case (RTC_SET_TIME):
      printc(" - RTC_Set_Time IN\n");
      break;
    case (RTC_SET_TIME | FUNC_OUT_MASK):
      printc(" - RTC_Set_Time OUT\n");
      break;
    case (RTC_SET_DATE_TIME):
      printc(" - RTC_Set_Date_Time IN\n");
      break;
    case (RTC_SET_DATE_TIME | FUNC_OUT_MASK):
      printc(" - RTC_Set_Date_Time OUT\n");
      break;
    case (RTC_GET_DATE):
      printc(" - RTC_Get_Date IN\n");
      break;
    case (RTC_GET_DATE | FUNC_OUT_MASK):
      printc(" - RTC_Get_Date OUT\n");
      break;
    case (RTC_GET_TIME):
      printc(" - RTC_Get_Time IN\n");
      break;
    case (RTC_GET_TIME | FUNC_OUT_MASK):
      printc(" - RTC_Get_Time OUT\n");
      break;
    case (RTC_GET_DATE_TIME):
      printc(" - RTC_Get_Date_Time IN\n");
      break;
    case (RTC_GET_DATE_TIME | FUNC_OUT_MASK):
      printc(" - RTC_Get_Date_Time OUT\n");
      break;
    case (RTC_ENABLE_ALARM):
      printc(" - RTC_Enable_Alarm IN\n");
      break;
    case (RTC_ENABLE_ALARM | FUNC_OUT_MASK):
      printc(" - RTC_Enable_Alarm OUT\n");
      break;
    case (RTC_CLEAR_INT):
      printc(" - RTC_Clear_Int IN\n");
      break;
    case (RTC_CLEAR_INT | FUNC_OUT_MASK):
      printc(" - RTC_Clear_Int OUT\n");
      break;
    case (RTC_REGISTER_SW_ALARM):
      printc(" - RTC_Register_SW_Alarm IN\n");
      break;
    case (RTC_REGISTER_SW_ALARM | FUNC_OUT_MASK):
      printc(" - RTC_Register_SW_Alarm OUT\n");
      break;
    case (RTC_UNREGISTER_SW_ALARM):
      printc(" - RTC_Unregister_SW_Alarm IN\n");
      break;
    case (RTC_UNREGISTER_SW_ALARM | FUNC_OUT_MASK):
      printc(" - RTC_Unregister_SW_Alarm OUT\n");
      break;
    case (RTC_GET_REGISTERED_SW_ALARM):
      printc(" - RTC_Get_Registered_SW_Alarm IN\n");
      break;
    case (RTC_GET_REGISTERED_SW_ALARM | FUNC_OUT_MASK):
      printc(" - RTC_Get_Registered_SW_Alarm OUT\n");
      break;
    case (RTC_SW_ALARM_CALLBACK):
      printc(" - RTC_SW_Alarm_Callback IN\n");
      break;
    case (RTC_SW_ALARM_CALLBACK | FUNC_OUT_MASK):
      printc(" - RTC_SW_Alarm_Callback OUT\n");
      break;
    
    case (FORMAT_DATE):
      printc(" - Format_Date IN\n");
      break;
    case (FORMAT_DATE | FUNC_OUT_MASK):
      printc(" - Format_Date OUT\n");
      break;
    case (FORMAT_TIME):
      printc(" - Format_Time IN\n");
      break;
    case (FORMAT_TIME | FUNC_OUT_MASK):
      printc(" - Format_Time OUT\n");
      break;
